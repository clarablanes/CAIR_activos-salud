...
var format_Ruta4_9 = new ol.format.GeoJSON();
var features_Ruta4_9 = format_Ruta4_9.readFeatures(json_Ruta4_9, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Ruta4_9 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Ruta4_9.addFeatures(features_Ruta4_9);
var lyr_Ruta4_9 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Ruta4_9, 
                style: style_Ruta4_9,
                popuplayertitle: 'Ruta4',
                interactive: true,
                title: '<img src="styles/legend/Ruta4_9.png" /> Ruta4'
            });
var format_Ruta3_10 = new ol.format.GeoJSON();
var features_Ruta3_10 = format_Ruta3_10.readFeatures(json_Ruta3_10, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Ruta3_10 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Ruta3_10.addFeatures(features_Ruta3_10);
var lyr_Ruta3_10 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Ruta3_10, 
                style: style_Ruta3_10,
                popuplayertitle: 'Ruta3',
                interactive: true,
                title: '<img src="styles/legend/Ruta3_10.png" /> Ruta3'
            });
var format_Ruta2_11 = new ol.format.GeoJSON();
var features_Ruta2_11 = format_Ruta2_11.readFeatures(json_Ruta2_11, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Ruta2_11 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Ruta2_11.addFeatures(features_Ruta2_11);
var lyr_Ruta2_11 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Ruta2_11, 
                style: style_Ruta2_11,
                popuplayertitle: 'Ruta2',
                interactive: true,
                title: '<img src="styles/legend/Ruta2_11.png" /> Ruta2'
            });
var format_Ruta1_12 = new ol.format.GeoJSON();
var features_Ruta1_12 = format_Ruta1_12.readFeatures(json_Ruta1_12, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Ruta1_12 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Ruta1_12.addFeatures(features_Ruta1_12);
var lyr_Ruta1_12 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Ruta1_12, 
                style: style_Ruta1_12,
                popuplayertitle: 'Ruta1',
                interactive: true,
                title: '<img src="styles/legend/Ruta1_12.png" /> Ruta1'
            });
var format_labels_git_13 = new ol.format.GeoJSON();
var features_labels_git_13 = format_labels_git_13.readFeatures(json_labels_git_13, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_labels_git_13 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_labels_git_13.addFeatures(features_labels_git_13);
var lyr_labels_git_13 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_labels_git_13, 
                style: style_labels_git_13,
                popuplayertitle: 'labels_git',
                interactive: true,
                title: '<img src="styles/legend/labels_git_13.png" /> labels_git'
            });

lyr_OpenStreetMap_0.setVisible(true);lyr_2705_R2_1.setVisible(true);lyr_2705_R1_2.setVisible(true);lyr_2005_R3_3.setVisible(true);lyr_2005_R2_4.setVisible(true);lyr_2005_R1_5.setVisible(true);lyr_505_R3_6.setVisible(true);lyr_505_R2_7.setVisible(true);lyr_505_R1_8.setVisible(true);lyr_Ruta4_9.setVisible(true);lyr_Ruta3_10.setVisible(true);lyr_Ruta2_11.setVisible(true);lyr_Ruta1_12.setVisible(true);lyr_labels_git_13.setVisible(true);
var layersList = [lyr_OpenStreetMap_0,lyr_2705_R2_1,lyr_2705_R1_2,lyr_2005_R3_3,lyr_2005_R2_4,lyr_2005_R1_5,lyr_505_R3_6,lyr_505_R2_7,lyr_505_R1_8,lyr_Ruta4_9,lyr_Ruta3_10,lyr_Ruta2_11,lyr_Ruta1_12,lyr_labels_git_13];
...
lyr_Ruta4_9.set('fieldAliases', {'fid': 'fid', 'photo': 'photo', 'filename': 'filename', 'directory': 'directory', 'altitude': 'altitude', 'direction': 'direction', 'rotation': 'rotation', 'longitude': 'longitude', 'latitude': 'latitude', 'timestamp': 'timestamp', 'TITULO': 'TITULO', 'ruta_web': 'ruta_web', });
lyr_Ruta3_10.set('fieldAliases', {'fid': 'fid', 'photo': 'photo', 'filename': 'filename', 'directory': 'directory', 'altitude': 'altitude', 'direction': 'direction', 'rotation': 'rotation', 'longitude': 'longitude', 'latitude': 'latitude', 'timestamp': 'timestamp', 'TITULO': 'TITULO', 'ruta_web': 'ruta_web', });
lyr_Ruta2_11.set('fieldAliases', {'fid': 'fid', 'photo': 'photo', 'filename': 'filename', 'directory': 'directory', 'altitude': 'altitude', 'direction': 'direction', 'rotation': 'rotation', 'longitude': 'longitude', 'latitude': 'latitude', 'timestamp': 'timestamp', 'TITULO': 'TITULO', 'ruta_web': 'ruta_web', });
lyr_Ruta1_12.set('fieldAliases', {'fid': 'fid', 'photo': 'photo', 'filename': 'filename', 'directory': 'directory', 'altitude': 'altitude', 'direction': 'direction', 'rotation': 'rotation', 'longitude': 'longitude', 'latitude': 'latitude', 'timestamp': 'timestamp', 'TITULO': 'TITULO', 'ruta_web': 'ruta_web', });
lyr_labels_git_13.set('fieldAliases', {'fid': 'fid', 'Label': 'Label', 'auxiliary_storage_labeling_positionx': 'auxiliary_storage_labeling_positionx', 'auxiliary_storage_labeling_positiony': 'auxiliary_storage_labeling_positiony', });
...
lyr_Ruta4_9.set('fieldImages', {'fid': 'Hidden', 'photo': 'Hidden', 'filename': 'Hidden', 'directory': 'Hidden', 'altitude': 'Hidden', 'direction': 'Hidden', 'rotation': 'Hidden', 'longitude': 'Hidden', 'latitude': 'Hidden', 'timestamp': 'Hidden', 'TITULO': 'TextEdit', 'ruta_web': 'ExternalResource', });
lyr_Ruta3_10.set('fieldImages', {'fid': 'Hidden', 'photo': 'Hidden', 'filename': 'Hidden', 'directory': 'Hidden', 'altitude': 'Hidden', 'direction': 'Hidden', 'rotation': 'Hidden', 'longitude': 'Hidden', 'latitude': 'Hidden', 'timestamp': 'Hidden', 'TITULO': 'TextEdit', 'ruta_web': 'ExternalResource', });
lyr_Ruta2_11.set('fieldImages', {'fid': 'Hidden', 'photo': 'Hidden', 'filename': 'Hidden', 'directory': 'Hidden', 'altitude': 'Hidden', 'direction': 'Hidden', 'rotation': 'Hidden', 'longitude': 'Hidden', 'latitude': 'Hidden', 'timestamp': 'Hidden', 'TITULO': 'TextEdit', 'ruta_web': 'ExternalResource', });
lyr_Ruta1_12.set('fieldImages', {'fid': 'Hidden', 'photo': 'Hidden', 'filename': 'Hidden', 'directory': 'Hidden', 'altitude': 'Hidden', 'direction': 'Hidden', 'rotation': 'Hidden', 'longitude': 'Hidden', 'latitude': 'Hidden', 'timestamp': 'Hidden', 'TITULO': 'TextEdit', 'ruta_web': 'ExternalResource', });
lyr_labels_git_13.set('fieldImages', {'fid': 'TextEdit', 'Label': 'TextEdit', 'auxiliary_storage_labeling_positionx': 'Hidden', 'auxiliary_storage_labeling_positiony': 'Hidden', });
...
lyr_Ruta4_9.set('fieldLabels', {'TITULO': 'no label', 'ruta_web': 'no label', });
lyr_Ruta3_10.set('fieldLabels', {'TITULO': 'no label', 'ruta_web': 'no label', });
lyr_Ruta2_11.set('fieldLabels', {'TITULO': 'no label', 'ruta_web': 'no label', });
lyr_Ruta1_12.set('fieldLabels', {'TITULO': 'no label', 'ruta_web': 'no label', });
lyr_labels_git_13.set('fieldLabels', {'fid': 'no label', 'Label': 'no label', });
lyr_labels_git_13.on('precompose', function(evt) {
