...
var format_Ruta1_6 = new ol.format.GeoJSON();
var features_Ruta1_6 = format_Ruta1_6.readFeatures(json_Ruta1_6, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Ruta1_6 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Ruta1_6.addFeatures(features_Ruta1_6);
var lyr_Ruta1_6 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Ruta1_6, 
                style: style_Ruta1_6,
                popuplayertitle: 'Ruta1',
                interactive: true,
                title: '<img src="styles/legend/Ruta1_6.png" /> Ruta1'
            });
...
lyr_OpenStreetMap_0.setVisible(true);lyr_2705_R2_1.setVisible(true);lyr_2705_R1_2.setVisible(true);lyr_2005_R3_3.setVisible(true);lyr_2005_R2_4.setVisible(true);lyr_2005_R1_5.setVisible(true);lyr_Ruta1_6.setVisible(true);lyr_505_R3_7.setVisible(true);lyr_505_R2_8.setVisible(true);lyr_505_R1_9.setVisible(true);lyr_labels_git_10.setVisible(true);
var layersList = [lyr_OpenStreetMap_0,lyr_2705_R2_1,lyr_2705_R1_2,lyr_2005_R3_3,lyr_2005_R2_4,lyr_2005_R1_5,lyr_Ruta1_6,lyr_505_R3_7,lyr_505_R2_8,lyr_505_R1_9,lyr_labels_git_10];
...
lyr_Ruta1_6.set('fieldAliases', {'fid': 'fid', 'photo': 'photo', 'filename': 'filename', 'directory': 'directory', 'altitude': 'altitude', 'direction': 'direction', 'rotation': 'rotation', 'longitude': 'longitude', 'latitude': 'latitude', 'timestamp': 'timestamp', 'TITULO': 'TITULO', 'ruta_web': 'ruta_web', });
...
lyr_Ruta1_6.set('fieldImages', {'fid': 'Hidden', 'photo': 'Hidden', 'filename': 'Hidden', 'directory': 'Hidden', 'altitude': 'Hidden', 'direction': 'Hidden', 'rotation': 'Hidden', 'longitude': 'Hidden', 'latitude': 'Hidden', 'timestamp': 'Hidden', 'TITULO': 'TextEdit', 'ruta_web': 'ExternalResource', });
...
lyr_Ruta1_6.set('fieldLabels', {'TITULO': 'inline label - always visible', 'ruta_web': 'no label', });
